...
while True:
    ...
    if time.time() - timeStart < totalTime:
        ...
        cvzone.putTextRect(img, f'Time: {int(totalTime - (time.time() - timeStart))}',
                           (1000, 50), scale=2, offset=20)
        cvzone.putTextRect(img, f'Score: {str(score).zfill(2)}', (60, 50), scale=1.3, offset=20)
        cvzone.putTextRect(img, f'Remarks: {str(feedback).zfill(2)}', (60, 100), scale=1.3, offset=20)
